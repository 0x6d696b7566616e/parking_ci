...
<html lang="en">
  <head>
    ...
    <title>400 - E-Parking Admin Dashboard</title>
        ...
        <div class="col-md-8 col-12 offset-md-2">
          <div class="text-center">
            ...
            <p class="fs-5 text-gray-600">
              Bad request to this server. Please check your request.
            </p>
            <a href="<?= base_url('login') ?>" class="btn btn-lg btn-outline-primary mt-3"
              >Go Home</a
            >
          </div>
        </div>
