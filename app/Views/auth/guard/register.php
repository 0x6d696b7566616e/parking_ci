        ...
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                ...
                <p class="auth-subtitle mb-5">
                    Input your data to register as a Security Guard.
                </p>

                <form action="<?= base_url('guard/register') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="email" class="form-control form-control-xl" required value="<?= set_value('email') ?>" name="email" placeholder="Email" />
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <input type="text" class="form-control form-control-xl" required value="<?= set_value('nip') ?>" name="nip" placeholder="NIP" />
                        <div class="form-control-icon">
                            <i class="bi bi-person"></i>
                        </div>
                        <p class="text-danger mt-2 mb-0"><?= isset($validation) ? str_replace('_', ' ', $validation->getError('nip')) : '' ?></p>
                    </div>
                    <div class="form-group position-relative has-icon-left mb-4">
                    ...
                    <div class="form-group position-relative has-icon-left mb-4">
                        <div class="form-check">
                            <div class="checkbox">
                                ...
                                <label for="is_admin">Register As a Admin</label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="text-center mt-5 text-lg fs-4">
                    <p class="text-gray-600">
                        ...
                        <a href="<?= base_url('guard/login') ?>" class="font-bold">Log in</a>.
                    </p>
                </div>
            </div>
        </div>
