                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">
                                Please, complete your vehicle data correctly.
                            </p>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="<?= base_url('dashboard/create-vehicle') ?>" method="post">
                                            <?= csrf_field() ?>
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="nama" class="form-control" required  value="<?= set_value('nama') ?>"  name="nama" placeholder="Ex. Honda Vario 2018" />
                                                    ...
                                                    <div class="col-md-8 mt-md-3 form-group">
                                                        <input type="text" id="plat" class="form-control" required  value="<?= set_value('plat') ?>"  name="plat" placeholder="Ex. AB XXXX XX" />
