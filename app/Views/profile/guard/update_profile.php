                    ...
                    <div class="row match-height">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" action="<?= base_url('guard/dashboard/update-profile') ?>" method="post" enctype="multipart/form-data">
                                            <?= csrf_field() ?>
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-4 mt-md-3">
                                                        <label for="id-card">Profile Picture</label>
                                                    </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="<?= base_url('guard/dashboard/update-email') ?>">
                                            <?= csrf_field() ?>
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="email" id="email" class="form-control" value="<?= empty(set_value('email')) ? $curr['email'] : set_value('email') ?>" required name="email" placeholder="yours@mail.com" />
                                                    ...
                                                    <div class="col-md-8 form-group mt-md-3">
                                                        <input type="text" id="password" class="form-control" required name="confirm_password" placeholder="" />
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form class="form form-horizontal" method="post" action="<?= base_url('guard/dashboard/update-nip') ?>">
                                            <?= csrf_field() ?>
                                            <div class="form-body">
                                                <div class="row">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8 form-group">
                                                        <input type="text" id="nim" class="form-control" value="<?= empty(set_value('nip')) ? $curr['nip'] : set_value('nip') ?>" required name="nip" placeholder="11 XXXXXX" />
                                                        <p class="text-danger mt-1 mb-0"><?= isset($validation) ? str_replace('_', ' ', $validation->getError('nip')) : '' ?></p>
                                                    </div>
                                                    <div class="col-md-4 mt-md-3">
                                                        <label for="password">Confirm Password</label>
                                                    </div>
                                                    ...
                                                    <div class="col-12 mt-md-3">
                                                        <p class="text-danger text-center m-0"><?= !empty(session()->getFlashdata('error_nip')) ? session()->getFlashdata('error_nip') : '' ?></p>
                                                    </div>
                                                    <div class="col-sm-12 d-flex justify-content-end mt-5">
                                                        <button type="submit" class="btn btn-primary me-1 mb-1">
                                                            Submit
